...
const games = [
  {
    ...
    description: 'Choose your dream home — a castle, treehouse, igloo, and more — then decorate it and save your creation!',
    tags: ['Creative', 'Design', 'Fun'],
    color: 'pink' as const,
    badge: null,
  },
  {
    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#FEF6FB' }}>
      ...
      <div className="text-center pt-10 pb-4 px-4 relative z-10">
        ...
        <h1 className="text-[38px] font-bold tracking-tight leading-tight" style={{ color: '#1A0818' }}>
          Playing <span style={{ color: '#FF4FAE' }}>Hub</span>
        </h1>
